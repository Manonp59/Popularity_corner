...
class BoxOfficeSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        items["title"] = response.xpath('//*[@id="content-layout"]/section[3]/div[2]/ul/li[1]/div/div[1]/h2/a/text()').extract()
        items["entrance"] = //*[@id="content-layout"]/section[3]/div[2]/ul/li[3]/div/div[1]/h2/a
        items["date_release"] =
        pass
