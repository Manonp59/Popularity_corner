...
class BoxOfficeSpider(CrawlSpider):
    ...
    def parse_box_office(self, response):
        ...
        if box_office_raw:
            ...
            item['box_office_france_1ere_semaine'] = box_office_cleaned
        else:
            item['box_office_france_1ere_semaine'] = None
        yield item
    ...
    def parse_box_office(self, response):
        ...
        items["week"] = f"{date}"
        # You can also extract box office data here using response.css or response.xpath
