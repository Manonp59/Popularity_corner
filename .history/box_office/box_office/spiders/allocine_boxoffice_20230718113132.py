...
class BoxOfficeSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        items["title"] = response.css('#content-layout > section.section.section-wrap.gd-3-cols.gd-gap-20 > div.gd-col-middle > ul > li:nth-child(3) > div > div.meta.meta-affintiy-score > h2 > ').extract()
        items["entrance"] = 
        items["date_release"] =
        pass
