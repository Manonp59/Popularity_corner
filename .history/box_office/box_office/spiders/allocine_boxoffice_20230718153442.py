...
class BoxOfficeSpider(CrawlSpider):
    ...
    rules = (
        ...
        Rule(LinkExtractor(restrict_css='div.gd-col-middle ul li.mdl h2 a'), callback='parse_item', follow=True),
        # La deuxième règle pour suivre les liens vers les pages suivantes de la liste de films.
        Rule(LinkExtractor(restrict_css='div.pagination-item-holder a.pagination-item'), follow=True),
    )
