...
class BoxOfficeSpider(CrawlSpider):
    ...
    def parse_score(self, response):
        ...
        items["date_release"] = first_row.css('td.responsive-table-column.first-col span::text').get()
        items["entrance"] = first_row.css('td.responsive-table-column.second-col::text').get().s
