...
class BoxOfficeSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        items["date_release"] = response.xpath('//a[contains(@class, "xXx") and contains(@class, "item") and contains(@class, "first-col") and contains(@class, "blue-link")][1]/text()').extra()
        items["entrance"] = response.xpath
        pass
